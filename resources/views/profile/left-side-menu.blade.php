    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div class="topbar-left">
            <a href="{{route('home')}}" class="logo">
                <span>
                    <img src="admin/assets/images/not-pau.png" alt="" height="22">
                </span>
                <i>
                    <img src="admin/assets/images/not-pau.png" alt="" height="28">
                </i>
            </a>
        </div>
        ...
        <div class="user-box">
            <div class="user-img">
              <?php if (isset(Auth::user()->id)): ?>
                <img src="{{URL::asset('admin/assets/images/users/'.Auth::user()->image)}}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
                <?php else: ?>
                  <img src="{{URL::asset('admin/assets/images/users/avatar-1.jpg')}}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">

              <?php endif; ?>
            </div>
          <?php if (isset(Auth::user()->name)) {
            echo '  <h5><a href="hesabim">'.Auth::user()->name.'</a> </h5>';
          } ?>
        ...
        <div id="sidebar-menu">
            ...
            <?php if (isset(Auth::user()->id)): ?>
              <ul class="metismenu" id="side-menu">
                  ...
                  <li>
                      <a href="{{route('not-yukle')}}">
                          <i class="fi-air-play"></i> <span> Not Yükle </span>
                      </a>
                  </li>
