<div class="left side-menu">
    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div class="topbar-left">
            <a href="{{route('admins')}}" class="logo">
                <span>
                    <img src="admin/assets/images/logo_light.png" alt="" height="22">
                </span>
                <i>
        ...
        <div class="user-box">
            ...
            <h5><a href="#">Yunus Emre ERKEN</a> </h5>
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="{{route('uyeler')}}">
                        <i class="fi-air-play"></i> <span> Üyeler </span>
                    </a>
                </li>

                <li>
                    <a href="{{route('notlar')}}"><i class="fi-layers"></i> <span> Notlar </span> </a>
